...
public class StandardFormatPropertySource extends AbstractPropertySource
		implements IPropertySource {

	public static final String PROPERTY_MIME_TYPE = "SensorMLEditor.mime.type";
	public PropertyDescriptor definitionDescriptor;

	boolean stop = false;

	public StandardFormatPropertySource(Element element,
	...
	public boolean isMimeType(Node node) {
		String refName = dom.getAttributeValue((Element) node, "name");
		return refName.equals("mimeType");
	}
	...
	public Object getPropertyValue(Object id) {
		String label = null;
		if ((id == PROPERTY_MIME_TYPE) && (definitionDescriptor != null)) {
