...
public class CountPropertySource extends AbstractPropertySource implements
		IPropertySource {
	public static final String PROPERTY_COUNT_VALUE = "SensorMLEditor.swe.Count";
	public TextPropertyDescriptor nameDescriptor;

	public CountPropertySource(Element element, DOMHelper domHelper,
	...
	public boolean isCountValue(Node node) {
		...
		return refName.equals("swe.countValue");
	}
	 ...
	 * str = (String) value; if ((id == PROPERTY_COUNT_VALUE ) &&
	 * (nameDescriptor != null)) { PropertyLabelProvider propProvider =
	 * (PropertyLabelProvider) nameDescriptor .getLabelProvider(); Node
	 * changeNode = propProvider.getNode(); domUtil.setElementValue(changeNode,
	 * str); domUtil.selectOptionalChild(changeNode); }
	 * this.firePropertyChange("INSERT", null,null); }
	 */
