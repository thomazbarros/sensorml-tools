...
public class TimePropertySource extends AbstractPropertySource implements
		IPropertySource {
	public static final String PROPERTY_VALUE = "SensorMLEditor.swe.value";
	public TextPropertyDescriptor nameDescriptor;


	public TimePropertySource(Element element, DOMHelper domHelper,
	...
	public boolean isCountValue(Node node) {
		...
		return refName.equals("swe.timeValue");
	}
	 ...
	 * str = (String) value; if ((id == PROPERTY_VALUE ) && (nameDescriptor !=
