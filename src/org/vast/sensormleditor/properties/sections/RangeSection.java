...
import org.vast.sensormleditor.properties.descriptors.RangePropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class RangeSection extends AbstractPropertySection {
	...
	private RangePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new RangePropertySource(element, dom, treeViewer,
				smlEditor);
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource
					.setPropertyValue(RangePropertySource.PROPERTY_VALUE,
							valueText.getText());
		}
	};
	...
	public void refresh() {
		...
		if (RangePropertySource.PROPERTY_VALUE != null) {
			String valueValue = (String) propertySource
					.getPropertyValue(RangePropertySource.PROPERTY_VALUE);
			if (valueValue != null)
