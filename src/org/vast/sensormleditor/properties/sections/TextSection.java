...
import org.vast.sensormleditor.properties.descriptors.TextPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class TextSection extends AbstractPropertySection {
	...
	private TextPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new TextPropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					TextPropertySource.PROPERTY_VALUE,
	...
	public void refresh() {
		...
		if (TextPropertySource.PROPERTY_VALUE!= null) {
			

			String idValue = (String) propertySource
					.getPropertyValue(TextPropertySource.PROPERTY_VALUE);
			if (idValue != null)
