...
import org.vast.sensormleditor.properties.descriptors.CountPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class CountSection extends AbstractPropertySection {
	...
	private CountPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new CountPropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					CountPropertySource.PROPERTY_COUNT_VALUE,
	...
	public void refresh() {
		...
		if (CountPropertySource.PROPERTY_COUNT_VALUE!= null) {
			

			String idValue = (String) propertySource
					.getPropertyValue(CountPropertySource.PROPERTY_COUNT_VALUE);
			if (idValue != null)
