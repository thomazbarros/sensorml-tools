...
import org.vast.sensormleditor.properties.descriptors.SWEDefinitionPropertySource;
import org.vast.sensormleditor.util.DOMHelperAddOn;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class SWEDefinitionSection extends AbstractPropertySection {

	private Text definitionText;
	private String definitionLabel = "swe.definition:";
	...
	private SWEDefinitionPropertySource propertySource;

	private ModifyListener listener = new ModifyListener() {

		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					SWEDefinitionPropertySource.PROPERTY_DEFINITION,
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (chosenOne != null)
			element = chosenOne;
		if (element != null) {
			propertySource = new SWEDefinitionPropertySource(element,
	...
	public void refresh() {
		...
		if (SWEDefinitionPropertySource.PROPERTY_DEFINITION != null) {
			String definitionValue = (String) propertySource
					.getPropertyValue(SWEDefinitionPropertySource.PROPERTY_DEFINITION);
