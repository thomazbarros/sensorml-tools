...
import org.vast.sensormleditor.properties.descriptors.ClassifierPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class ClassifierSection extends AbstractPropertySection {

	private String headerLabel = "Classifier";
	...
	private ClassifierPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new ClassifierPropertySource(element, dom, treeViewer,smlEditor);
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					ClassifierPropertySource.PROPERTY_NAME, nameText.getText());
		}
	};
	...
	public void refresh() {
		if (ClassifierPropertySource.PROPERTY_NAME != null) {
			nameText.removeModifyListener(listener);
			String valueValue = (String) propertySource
					.getPropertyValue(ClassifierPropertySource.PROPERTY_NAME);
			if (valueValue != null)
