...
import org.vast.sensormleditor.properties.descriptors.SMLonlineResourcePropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class SMLonlineResourceSection extends AbstractPropertySection {

	private CLabel codespacelabelLabel;
	private Text codespaceText;
	private String codespaceLabel = "sml.onlineResource:";
	private SMLTreeEditor smlEditor;
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private SMLonlineResourcePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new SMLonlineResourcePropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource
					.setPropertyValue(
							SMLonlineResourcePropertySource.PROPERTY_SML_ONLINERESOURCE,
	...
	public void createControls(Composite parent,
		...
		codespacelabelLabel = getWidgetFactory().createCLabel(composite,
				codespaceLabel);
		data = new FormData();
		...
		data.top = new FormAttachment(0, ITabbedPropertyConstants.VSPACE);
		codespacelabelLabel.setLayoutData(data);
	}

	public void refresh() {

		codespaceText.removeModifyListener(listener);
		if (SMLonlineResourcePropertySource.PROPERTY_SML_ONLINERESOURCE != null) {

			String idValue = (String) propertySource
					.getPropertyValue(SMLonlineResourcePropertySource.PROPERTY_SML_ONLINERESOURCE);
			if (idValue != null)
