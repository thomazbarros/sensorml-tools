...
import org.vast.sensormleditor.properties.descriptors.SMLCapabilitiesPropertySource;
import org.vast.sensormleditor.util.DOMHelperAddOn;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class SMLCapabilitiesSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text codespaceText;
	private String codespaceLabel = "Capabilities:";

	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private SMLCapabilitiesPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (chosenOne != null)
			element = chosenOne;
		propertySource = new SMLCapabilitiesPropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					SMLCapabilitiesPropertySource.PROPERTY_SML_CAPABILITIES,
	...
	public void refresh() {
		...
		if (SMLCapabilitiesPropertySource.PROPERTY_SML_CAPABILITIES != null) {

			String idValue = (String) propertySource
					.getPropertyValue(SMLCapabilitiesPropertySource.PROPERTY_SML_CAPABILITIES);
			if (idValue != null)
