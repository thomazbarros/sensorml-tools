...
import org.vast.sensormleditor.properties.descriptors.OrganizationNamePropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class OrganizationNameSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text descriptionText;
	private String descriptionLabel = "Organization Name:";
	private SMLTreeEditor smlEditor;
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private OrganizationNamePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new OrganizationNamePropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					OrganizationNamePropertySource.PROPERTY_ORGANIZATION_NAME,
	...
	public void refresh() {
		...
		if (OrganizationNamePropertySource.PROPERTY_ORGANIZATION_NAME != null) {
			String idValue = (String) propertySource
					.getPropertyValue(OrganizationNamePropertySource.PROPERTY_ORGANIZATION_NAME);
			if (idValue != null)
