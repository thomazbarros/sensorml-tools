...
import org.vast.sensormleditor.properties.descriptors.ConditionalValuePropertySource;
...
public class ConditionalValueSection extends AbstractPropertySection {

	//private String headerLabel = "Data Record";
	//private CLabel headerlabelLabel;

	private String selectedFieldsLabel = "Selected Conditions:";
	private CLabel selectedlabelLabel;
	private String availableFieldsLabel = "Available Conditions:";
	...
	private ConditionalValuePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (dom.hasQName(element, "swe:ConditionalValue")) {
			propertySource = new ConditionalValuePropertySource(element, dom,
			...
			public void widgetSelected(SelectionEvent event) {
				...
				if (newfield != null && newfield != "") {
					...
					propertySource.setPropertyValue(
							ConditionalValuePropertySource.PROPERTY_SWE_CONDITION,
							"Enter name...");
