...
import org.vast.sensormleditor.properties.descriptors.XLinkHrefPropertySource;
import org.vast.sensormleditor.util.DOMHelperAddOn;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class XLinkHrefSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text descriptionText;
	private String descriptionLabel = "xlink.href:";
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private SMLTreeEditor smlEditor;
	private XLinkHrefPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (chosenOne != null)
			element = chosenOne;
		propertySource = new XLinkHrefPropertySource(element, dom, treeViewer,smlEditor);
...
/*	public Element getChosenField(Element element, Element returnEle) {
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					XLinkHrefPropertySource.PROPERTY_XLINK_HREF,
	...
	public void refresh() {
		...
		if (XLinkHrefPropertySource.PROPERTY_XLINK_HREF != null) {
			String idValue = (String) propertySource
					.getPropertyValue(XLinkHrefPropertySource.PROPERTY_XLINK_HREF);
