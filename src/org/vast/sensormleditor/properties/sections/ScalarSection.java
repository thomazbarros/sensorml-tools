...
import org.vast.sensormleditor.properties.descriptors.ScalarPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class ScalarSection extends AbstractPropertySection {
	...
	private ScalarPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new ScalarPropertySource(element, dom, treeViewer,
				smlEditor);
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					ScalarPropertySource.PROPERTY_VALUE, valueText.getText());
		}
	};
	...
	public void createControls(Composite parent,
		...
		valuelabelLabel.setToolTipText("Required Input");
		data = new FormData();
		data.left = new FormAttachment(0, 0);
	...
	public void refresh() {
		...
		if (ScalarPropertySource.PROPERTY_VALUE != null) {
			String valueValue = (String) propertySource
					.getPropertyValue(ScalarPropertySource.PROPERTY_VALUE);
			if (valueValue != null)
