...
import org.vast.sensormleditor.properties.descriptors.CodeSpacePropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class CodespaceSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text codespaceText;
	private String codespaceLabel = "Code Space:";
	private SMLTreeEditor smlEditor;
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private CodeSpacePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new CodeSpacePropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					CodeSpacePropertySource.PROPERTY_CODESPACE,
	...
	public void refresh() {
		...
		if (CodeSpacePropertySource.PROPERTY_CODESPACE != null) {
			String idValue = (String) propertySource
					.getPropertyValue(CodeSpacePropertySource.PROPERTY_CODESPACE);
