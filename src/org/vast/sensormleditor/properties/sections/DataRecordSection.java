...
public class DataRecordSection extends AbstractPropertySection {
	...
	private DataRecordPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (dom.hasQName(element, "swe:DataRecord")) {
			propertySource = new DataRecordPropertySource(element, dom,
