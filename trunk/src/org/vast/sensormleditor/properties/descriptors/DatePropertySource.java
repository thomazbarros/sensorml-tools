...
public class DatePropertySource extends AbstractPropertySource implements
		IPropertySource {
	public static final String PROPERTY_VALUE = "SensorMLEditor.gml.date";
	public TextPropertyDescriptor nameDescriptor;

	public DatePropertySource(Element element, DOMHelper domHelper,
	...
	public void initProperties() {
		if (ele.getNodeName().equals("rng:data")&& dom.getAttributeValue(ele,"type").equals("time")) {
			Node dateTime = ele;
			if (dateTime != null){
