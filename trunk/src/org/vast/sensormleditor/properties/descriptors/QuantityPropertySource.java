...
public class QuantityPropertySource extends AbstractPropertySource implements
		IPropertySource {
	public static final String PROPERTY_VALUE = "SensorMLEditor.swe.value";
	public TextPropertyDescriptor nameDescriptor;

	public QuantityPropertySource(Element element, DOMHelper domHelper,
	...
	public boolean isCountValue(Node node) {
		...
		return refName.equals("swe.quantityValue");
	}
