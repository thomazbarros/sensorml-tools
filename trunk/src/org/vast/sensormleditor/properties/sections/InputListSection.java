...
import org.vast.sensormleditor.properties.descriptors.InputListPropertySource;
import org.vast.sensormleditor.util.DOMHelperAddOn;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class InputListSection extends AbstractPropertySection {

	private String headerLabel = "Input List";
	...
	private InputListPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		// We know that element should be either "sml:InputList" or "sml:input"
		// If it is an output, we want to identify the type since it should be
		// selected
		if (dom.hasQName(element, "sml:InputList")) {
			propertySource = new InputListPropertySource(element, dom,
