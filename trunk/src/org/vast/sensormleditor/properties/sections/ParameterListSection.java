...
import org.vast.sensormleditor.properties.descriptors.ParameterListPropertySource;
import org.vast.sensormleditor.util.DOMHelperAddOn;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class ParameterListSection extends AbstractPropertySection {

	private String headerLabel = "ParameterList";
	...
	private ParameterListPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (dom.hasQName(element, "sml:ParameterList")) {
			propertySource = new ParameterListPropertySource(element, dom,
			...
			if (newEle != null) {
				propertySource = new ParameterListPropertySource(newEle, dom,
						treeViewer, smlEditor);
