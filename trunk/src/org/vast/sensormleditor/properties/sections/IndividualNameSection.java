...
public class IndividualNameSection extends AbstractPropertySection {

	private String headerLabel = "Responsible Party";
	private CLabel headerlabelLabel;

	private CLabel descriptionlabelLabel;
	private Text descriptionText;
	private String descriptionLabel = "Individual Name:";
	private SMLTreeEditor smlEditor;
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private IndividualNamePropertySource propertySource;
	// private Image optionalImg;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new IndividualNamePropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					IndividualNamePropertySource.PROPERTY_INDIVIDUAL_NAME,
	...
	public void refresh() {
		...
		if (IndividualNamePropertySource.PROPERTY_INDIVIDUAL_NAME != null) {
			

			String idValue = (String) propertySource
					.getPropertyValue(IndividualNamePropertySource.PROPERTY_INDIVIDUAL_NAME);
			if (idValue != null)
