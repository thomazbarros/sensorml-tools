...
import org.vast.sensormleditor.properties.descriptors.ContactInstructionsPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class ContactInstructionsSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text descriptionText;
	private String descriptionLabel = "Contact Instructions:";
	private SMLTreeEditor smlEditor;
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private ContactInstructionsPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new ContactInstructionsPropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource
					.setPropertyValue(
							ContactInstructionsPropertySource.PROPERTY_CONTACT_INSTRUCTIONS,
	...
	public void refresh() {
		...
		if (ContactInstructionsPropertySource.PROPERTY_CONTACT_INSTRUCTIONS != null) {

			String idValue = (String) propertySource
					.getPropertyValue(ContactInstructionsPropertySource.PROPERTY_CONTACT_INSTRUCTIONS);
			if (idValue != null)
