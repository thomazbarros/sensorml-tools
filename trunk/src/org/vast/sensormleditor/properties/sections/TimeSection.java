...
import org.vast.sensormleditor.properties.descriptors.TimePropertySource;
...
public class TimeSection extends AbstractPropertySection {
	...
	private TimePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new TimePropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					TimePropertySource.PROPERTY_VALUE,
	...
	public void refresh() {
		...
		if (TimePropertySource.PROPERTY_VALUE!= null) {
			

			String idValue = (String) propertySource
					.getPropertyValue(TimePropertySource.PROPERTY_VALUE);
			if (idValue != null)
