...
import org.vast.sensormleditor.properties.descriptors.DateTimePropertySource;
import org.vast.sensormleditor.util.DOMHelperAddOn;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class DateTimeSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text descriptionText;
	private String descriptionLabel = "DateTime:";
	
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private SMLTreeEditor smlEditor;
	private DateTimePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (chosenOne != null)
			element = chosenOne;
		if (element != null) {
			propertySource = new DateTimePropertySource(element, dom, treeViewer,smlEditor);
		}
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					DateTimePropertySource.PROPERTY_VALUE,
	...
	public void refresh() {
		...
		if (DateTimePropertySource.PROPERTY_VALUE!= null) {
			

			String idValue = (String) propertySource
					.getPropertyValue(DateTimePropertySource.PROPERTY_VALUE);
			if (idValue != null)
