...
import org.vast.sensormleditor.properties.descriptors.CategoryPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class CategorySection extends AbstractPropertySection {
	...
	private CategoryPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new CategoryPropertySource(element, dom, treeViewer,
				smlEditor);
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					CategoryPropertySource.PROPERTY_VALUE, descriptionText
							.getText());
	...
	public void createControls(Composite parent,
		 ...
		 * new FormAttachment(50, ITabbedPropertyConstants.HSPACE);
		 * 
	...
	public void refresh() {
		...
		if (CategoryPropertySource.PROPERTY_VALUE != null) {

			String idValue = (String) propertySource
					.getPropertyValue(CategoryPropertySource.PROPERTY_VALUE);
			if (idValue != null)
