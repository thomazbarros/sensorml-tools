...
import org.vast.sensormleditor.properties.descriptors.NumericalPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class NumericalSection extends AbstractPropertySection {
	...
	private NumericalPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new NumericalPropertySource(element, dom, treeViewer, smlEditor);
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource
					.setPropertyValue(NumericalPropertySource.PROPERTY_VALUE,
							valueText.getText());
		}
	};
	...
	public void refresh() {
		...
		if (NumericalPropertySource.PROPERTY_VALUE != null) {
			String valueValue = (String) propertySource
					.getPropertyValue(NumericalPropertySource.PROPERTY_VALUE);
			if (valueValue != null)
