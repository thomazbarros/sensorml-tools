...
import org.vast.sensormleditor.properties.descriptors.SMLFormatPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class SMLFormatSection extends AbstractPropertySection {

	private CLabel descriptionlabelLabel;
	private Text descriptionText;
	private String descriptionLabel = "Format:";
	private SMLTreeEditor smlEditor;
	private Element element;
	private DOMHelper dom;
	private TreeViewer treeViewer;
	private SMLFormatPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new SMLFormatPropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					SMLFormatPropertySource.PROPERTY_SML_FORMAT,
	...
	public void refresh() {
		...
		if (SMLFormatPropertySource.PROPERTY_SML_FORMAT != null) {
			descriptionText.removeModifyListener(listener);
			String idValue = (String) propertySource
					.getPropertyValue(SMLFormatPropertySource.PROPERTY_SML_FORMAT);
			if (idValue != null)
