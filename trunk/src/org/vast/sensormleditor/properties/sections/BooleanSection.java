...
import org.vast.sensormleditor.properties.descriptors.BooleanPropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class BooleanSection extends AbstractPropertySection {
	...
	private BooleanPropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new BooleanPropertySource(element, dom,
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					BooleanPropertySource.PROPERTY_VALUE,
	...
	public void refresh() {
		...
		if (BooleanPropertySource.PROPERTY_VALUE!= null) {
			

			String idValue = (String) propertySource
					.getPropertyValue(BooleanPropertySource.PROPERTY_VALUE);
			if (idValue != null)
