...
import org.vast.sensormleditor.properties.descriptors.ObservablePropertySource;
import org.vast.xml.DOMHelper;
import org.w3c.dom.Element;

public class ObservablePropertySection extends AbstractPropertySection {
	...
	private ObservablePropertySource propertySource;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySource = new ObservablePropertySource(element, dom, treeViewer, smlEditor);
	...
	private ModifyListener listener = new ModifyListener() {
		public void modifyText(ModifyEvent arg0) {
			propertySource.setPropertyValue(
					ObservablePropertySource.PROPERTY_VALUE,
					valueText.getText());
		}
	};
	...
	public void createControls(Composite parent,
		...
		data.right = new FormAttachment(50, ITabbedPropertyConstants.HSPACE);
		data.top = new FormAttachment(headerlabelLabel, ITabbedPropertyConstants.VSPACE);
	...
	public void refresh() {
		...
		if (ObservablePropertySource.PROPERTY_VALUE != null) {
			String valueValue = (String) propertySource
					.getPropertyValue(ObservablePropertySource.PROPERTY_VALUE);
			if (valueValue != null)
