...
public class SWEDefinitionTabFilter extends AbstractTabFilter {
			...
			if (ele.getNodeName().equals("swe:field") ||
				...
				if (chosenOne != null) {
					if (dom.hasQName(chosenOne, "swe:DataRecord") ||
							...
							dom.hasQName(chosenOne, "swe:Quantity") ||
							dom.hasQName(chosenOne, "swe:Boolean") ||
							dom.hasQName(chosenOne, "swe:Text") ||
							dom.hasQName(chosenOne, "swe:Count") ||
							dom.hasQName(chosenOne, "swe:Time") ||
